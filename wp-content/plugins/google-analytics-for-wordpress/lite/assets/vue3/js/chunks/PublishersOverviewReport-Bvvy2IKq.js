import { a1 as storeToRefs, C as watch, y as onMounted, o as openBlock, E as createBlock, D as withCtx, a as createBaseVNode, c as createElementBlock, b as createVNode, t as toDisplayString, u as unref, F as Fragment, s as createCommentVNode, j as ref, m as computed } from "./toastStore-BFDhxKQh.js";
import { _ as __$1, s as sprintf } from "./default-i18n-KrIlCc2E.js";
import { B as applyFiltersToQuery, E as relayReportingQuery, F as relayFallbackFetch, u as useOverviewReportStore, A as isSampleDataEnabled, b as buildApiFilters } from "../reports-CAGQu_Y_.js";
...
import { q as sanitizeHtml, n as getUpgradeUrl, j as getMiGlobal, t as getMonsterInsightsUrl } from "./ajax-C-oSp5vP.js";
import { f as formatPct, b as formatNum } from "./overviewTableFormatters-dHzA8ZV1.js";
...
import { _ as _sfc_main$2 } from "./ReportPieChart-hNHsYPgW.js";
    ...
    const landingRows = computed(() => {
      ...
      return rows.map((row) => {
        ...
        return {
          ...
          // via the column's linkKey, so it isn't shown as text. Sample rows get
          // no URL — their fabricated pages don't exist anywhere.
          pageTitle: String(title ?? ""),
          pageUrl: isSample.value ? "" : row.url || "",
