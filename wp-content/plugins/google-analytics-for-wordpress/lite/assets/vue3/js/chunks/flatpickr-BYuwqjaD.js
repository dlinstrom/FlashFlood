import { X as defineComponent, x as nextTick, Y as h } from "./toastStore-BFDhxKQh.js";
var HOOKS = [
  "onChange",
  "onClose",
  "onDayCreate",
    ...
    for (var i = 0; i < self.config.plugins.length; i++) {
      ...
      for (var key in pluginConf) {
        if (HOOKS.indexOf(key) > -1) {
          self.config[key] = arrayify$1(pluginConf[key]).map(bindToInstance).concat(self.config[key]);
