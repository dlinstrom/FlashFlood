...
import { e as generateTrafficCampaignSample, h as fetchTrafficCampaignData } from "./trafficSampleData-OLCJUN9c.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const columns = [
      { key: "campaign", label: __("Campaign", "google-analytics-for-wordpress"), sortable: true },
      ...
      return openBlock(), createBlock(ReportPageLayout, {
        ...
        table: withCtx(() => [
          createVNode(_sfc_main$1, {
            title: unref(__)("Campaign Details", "google-analytics-for-wordpress"),
            columns,
            ...
            loading: unref(loading),
            searchable: "",
            "empty-message": unref(__)("No data currently for the Campaigns report.", "google-analytics-for-wordpress")
